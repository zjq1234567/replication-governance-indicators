/******************************************************************************/
// Program to prepare data from the World Economic Forum Global Competitiveness 
// Survey (GCS) 
//
// Contents:
...
// Annual update notes: No need to update annually, data for all years read from Data tab
/******************************************************************************/
...
global inputfile "$gcs_inputfile"
global outputfile "$gcs_outputfile"
...
/******************************************************************************/
// SECTION 2: Load data from the data tab
/******************************************************************************/
clear
